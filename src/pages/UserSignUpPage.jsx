      ...
      <main className="flex-grow flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-xl">
          ...
          <form className="space-y-6" onSubmit={signupUser}>
            ...
            {/* ✅ Role Radio Button (Fixed to User) */}
            <div>
              ...
              <label className="inline-flex items-center bg-gray-100 px-4 py-2 rounded-md">
                ...
                />
                <span className="text-gray-700 font-medium">User (default)</span>
              </label>
            </div>

            <button
              type="submit"
              className={`w-full font-semibold py-3 rounded-md shadow-md transition duration-300 ${isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-yellow-600 hover:bg-yellow-400 text-white'}`}
